...
{
    register_taxonomy(
        'primary_category',  get_post_types([], 'names'), array( //this taxonomy applies to all post types; possible improvement, make it a setting to include specified post types.
        'hierarchical'      => false,
        'show_ui'           => true,
